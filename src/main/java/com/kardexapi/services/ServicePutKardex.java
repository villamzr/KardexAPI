...
import com.kardexapi.dto.KardexPut;
...
public class ServicePutKardex {
	...
	private ResponseEntity<KardexPut> restTemplateResult;
	...
	public RestTemplate consume(String url, Map<String, String> map) {
		...
		try {
			...
			setRestTemplateResult(restTemplate.exchange(url,HttpMethod.PUT, request, KardexPut.class)); 
		} catch (Exception e) {
	...
	public ResponseEntity<KardexPut> getRestTemplateResult() {
		return restTemplateResult;
	}

	public void setRestTemplateResult(ResponseEntity<KardexPut> restTemplateResult) {
